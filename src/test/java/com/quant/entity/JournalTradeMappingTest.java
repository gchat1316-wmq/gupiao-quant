...
/**
 * Verifies JournalTrade field names and column annotations match the DDL in
 * SchemaInitializer.ensureJournalTables().
 */
...
class JournalTradeMappingTest {
  ...
  void allFieldsAreMapped() throws Exception {
    ...
    Set<String> actual =
        java.util.stream.Stream.of(JournalTrade.class.getDeclaredFields())
            .map(Field::getName)
