...
public interface TradeStockRealtimeKlineRepository
    extends JpaRepository<TradeStockRealtimeKline, Long> {
  ...
  List<TradeStockRealtimeKline> findLatestByStockCodesAndPeriod(
      @Param("codes") Collection<String> codes, @Param("period") String period);
}
