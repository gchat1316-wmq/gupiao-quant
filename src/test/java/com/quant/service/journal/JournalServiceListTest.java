...
class JournalServiceListTest {
    ...
    void pendingFills_excludesOpenAndAddActions() {
        ...
        when(fillRepo.findRecentSince(any(LocalDateTime.class))).thenReturn(List.of(openFill, addFill, clearFill));
    ...
    void syncFromFill_missingFill_throwsIAE() {
        ...
        var ex = assertThrows(IllegalArgumentException.class,
                () -> service.syncFromFill(999L, "user-1"));
    ...
    void syncFromFill_duplicateSync_throwsISE() {
        ...
        var ex = assertThrows(IllegalStateException.class,
                () -> service.syncFromFill(20L, "user-1"));
