...
class XieboRecentSubscriptionServiceTest {
    ...
    void upsert_newSubscription_createsRow() {
        ...
        when(repo.save(any(UserStockSubscription.class))).thenAnswer(inv -> {
        ...
        ArgumentCaptor<UserStockSubscription> captor = ArgumentCaptor.forClass(UserStockSubscription.class);
    ...
    void upsert_existingSubscription_updatesFields() {
        ...
        UserSubscriptionDto out = service.upsert(7L, "600519",
                req(true, new BigDecimal("1820")));
    ...
    void upsert_zeroPrice_throwsIllegalArgument() {
        assertThatThrownBy(() -> service.upsert(7L, "600519",
                req(true, BigDecimal.ZERO)))
