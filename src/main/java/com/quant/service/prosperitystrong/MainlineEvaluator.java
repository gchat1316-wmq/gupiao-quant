 ...
 * Step 4: 主线判定与评分
 *
 * <p>主营占比得分: 主营占比 >= 50% 得 100, < 30% 直接 0, 中间线性 净利率接近 25% 得分: score = 100 - |netMargin - 25| * 2
...
public class MainlineEvaluator {
  ...
  public Score evaluate(
      BigDecimal mainBizRatio, BigDecimal netMarginAvg4q, BigDecimal financeScore) {
