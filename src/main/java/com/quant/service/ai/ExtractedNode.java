...
public class ExtractedNode {
  ...
  @Builder.Default private List<ExtractedNode> children = new ArrayList<>();

  public static ExtractedNode node(
      String title, String summary, String definition, ExtractedNode... children) {
