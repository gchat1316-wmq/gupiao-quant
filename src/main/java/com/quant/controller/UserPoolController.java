...
public class UserPoolController {
    ...
    public UserPoolController(UserPoolRepository userPoolRepository,
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<?> createPool(@RequestBody CreatePoolRequest req,
        ...
        log(principal.getId(), "CREATE_POOL", "pool:" + pool.getId(),
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<?> updatePool(@PathVariable Long id,
    ...
    public ResponseEntity<?> addStock(@PathVariable Long id,
        ...
        log(principal.getId(), "ADD_STOCK", "pool:" + id, Map.of("code", req.code(), "name", req.name()));
    ...
    @Transactional
    public ResponseEntity<?> updateStockNote(@PathVariable Long id,
                                              @PathVariable String code,
