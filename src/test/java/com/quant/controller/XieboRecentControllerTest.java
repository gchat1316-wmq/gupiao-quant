...
class XieboRecentControllerTest {
  ...
  @MockBean XieboRecentService service;
  ...
  void list_noAuth_returns200() throws Exception {
    RecentWatchDto dto =
        RecentWatchDto.builder()
            .stockCode("600519")
            .stockName("贵州茅台")
            .type("质量优选")
            .currentPrice(new BigDecimal("1893.20"))
            .hasNote(false)
            .build();
  ...
  void note_returnsDto() throws Exception {
    RecentNoteDto dto = RecentNoteDto.builder().stockCode("600519").noteHtml("<p>好</p>").build();
