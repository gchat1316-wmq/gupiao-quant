...
class MonitorAlertTemplateTest {
    ...
    void rendersCompactTemplate() {
        ...
        MonitorSignal sig = MonitorSignal.fixedPriceSell(
                pos, "000001.SZ", "平安银行",
    ...
    void rendersVerboseTemplate() {
        ...
        MonitorSignal sig = MonitorSignal.takeProfit(
                pos, "300750.SZ", "宁德时代",
                new BigDecimal("250.00"), new BigDecimal("100.00"), new BigDecimal("20.00"));
