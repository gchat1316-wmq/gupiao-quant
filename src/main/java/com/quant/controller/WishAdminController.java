...
public class WishAdminController {
    ...
    /** 列表(分页+状态+关键字) */
    @GetMapping
    public Map<String, Object> list(@RequestParam(name = "status", required = false) WishPool.Status status,
    ...
    public WishAdminDto reply(@PathVariable Long id,
    ...
    public WishAdminDto setDisplay(@PathVariable Long id,
