...
public class MiniMaxClient {
   ...
   */
  public String chatCompleteVision(
      String systemPrompt, String userPrompt, String imageBase64, String imageMediaType) {
  ...
  private String chatCompleteInternal(
      String systemPrompt, String userPrompt, String imageBase64, String imageMediaType) {
    ...
    if (imageBase64 == null) {
      ...
      userContent = List.of(imageBlock, Map.of("type", "text", "text", userPrompt));
    }
    ...
    log.info(
        "MiniMax 调用: model={}, vision={}, prompt长度={}",
        model,
        imageBase64 != null,
        userPrompt.length());
    String respStr;
