...
public class ProsperityStrongController {
  ...
  public Map<String, Object> windSearchStocks(
      @RequestParam(value = "question", defaultValue = "筛选沪深市场近5日涨幅居前且换手率较高且非ST的股票")
          String question,
  ...
  @GetMapping("/pool")
  public List<ProsperityPoolItemDTO> pool(@AuthenticationPrincipal UserPrincipal principal) {
