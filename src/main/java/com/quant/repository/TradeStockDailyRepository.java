...
public interface TradeStockDailyRepository extends JpaRepository<TradeStockDaily, Integer> {
  ...
  @Query(
      value =
          """
            ...
            """,
      nativeQuery = true)
  List<TradeStockDaily> findRecentKlineBatch(
      @Param("codes") Collection<String> codes,
      @Param("cutoffDate") LocalDate cutoffDate,
      @Param("topN") int topN);

  List<TradeStockDaily> findByStockCodeAndTradeDateGreaterThanOrderByTradeDateAsc(
  ...
  List<TradeStockDaily> findFirstAfterDateByStockCodes(
      @Param("codes") Collection<String> codes, @Param("fromDate") LocalDate fromDate);
}
