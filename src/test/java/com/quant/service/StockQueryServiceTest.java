...
class StockQueryServiceTest {
  ...
  void setUp() {
    ...
    service =
        new StockQueryService(
            stockBasicRepository, financialRepository, aStockDataQuoteService, jdbcTemplate);
  }
  ...
  private TradeStockFinancial tenPsFin(
      double netMarginPct, double revenueYi, double revenueYoyPct) {
    TradeStockFinancial f = new TradeStockFinancial();
