...
public class UserXieboRecentController {
    ...
    @PreAuthorize("isAuthenticated()")
    public Map<String, Object> upsert(@AuthenticationPrincipal UserPrincipal me,
    ...
    @PreAuthorize("isAuthenticated()")
    public Map<String, Object> resetAlerts(@AuthenticationPrincipal UserPrincipal me,
                                           @PathVariable String stockCode) {
    ...
    @PreAuthorize("isAuthenticated()")
    public Map<String, Object> setSckey(@AuthenticationPrincipal UserPrincipal me,
