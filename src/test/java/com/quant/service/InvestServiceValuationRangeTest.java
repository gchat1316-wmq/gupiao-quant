...
import com.quant.service.InvestService.ValuationVerdict;
...
class InvestServiceValuationRangeTest {
  ...
  void undervaluedUsesY1() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("100"), new BigDecimal("20"), null);
  ...
  void bubbleUsesY2() {
    ValuationVerdict v =
        InvestService.inferValuationRange(
            new BigDecimal("1500"),
  ...
  void boundaryEqualY1FairIsFair() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("200"), new BigDecimal("20"), null);
  ...
  void boundaryEqualY2FairIsFair() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("300"), null, new BigDecimal("30"));
  ...
  void fairZoneWithoutY1() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("120"), null, new BigDecimal("20"));
  ...
  void fairZoneWithoutY2() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("250"), new BigDecimal("20"), null);
  ...
  void noMarketCap() {
    ValuationVerdict v = InvestService.inferValuationRange(null, new BigDecimal("20"), null);
  ...
  void noForecasts() {
    ValuationVerdict v = InvestService.inferValuationRange(new BigDecimal("500"), null, null);
    assertThat(v.level()).isNull();
    assertThat(v.degree()).isNull();
    assertThat(v.refYear()).isNull();
  }
  ...
  void bubbleWithOnlyY2() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("1500"), null, new BigDecimal("100"));
  ...
  void fairWithOnlyY1Above() {
    ValuationVerdict v =
        InvestService.inferValuationRange(new BigDecimal("9999"), new BigDecimal("20"), null);
